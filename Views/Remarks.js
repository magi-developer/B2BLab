...
var handleRemarks = function (response) {
    ...
    section.append("<a class='course-title' href='#' onclick='history.back(); return false;'><h4>⬅️ Back</h4></a>");
    ...
    section.append("<ul class='styled-list'><li style='display:flex; justify-content:space-between;'><span>✔️ Validated By</span><span>" + response.validatedBy +
        ...
        "</span></li><li style='display:flex; justify-content:space-between;'><span>📝 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style='text-align:justify;'>" + response.overallRemarks +
        "</span></li></ul>");
    ...
    section.append("<div class='navigation'><a href='#' class='nav-btn leftNav' onclick='history.back(); return false;'>⬅️ Back</a></div>");
}